...
path2 = "/Users/mac/Desktop/t3_mnt/transformer_tape_dnabert/data/unknown_data_for_known_task/"
ipath = f"{path}final_all_representatives_rep_seq.fasta"
opath = f"{path2}final_6000.npy"
...
def add_label_protein(rnalist):
    ...
    for rnaseq in rnalist:
        count += get_label_and_pro(rnaseq)
        print(count)
        if count > 5010:
            break
...
if __name__ == '__main__':
    ...
    print(len(high_count_list))
    samplenum_from_remain = 1400 - len(high_count_list)

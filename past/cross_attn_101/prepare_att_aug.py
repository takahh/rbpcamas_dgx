...
if rmode == "all":
    ...
    path = path.replace('data', 'data_lncRNA')
    PATH2 = f"/Users/mac/Documents/transformer_tape_dnabert/data/known_protein_lncRNA/"
elif rmode == "all_unknown":
    PATH2 = f"/Users/mac/Desktop/t3_mnt/transformer_tape_dnabert/data/selected_rna_with_proteinseqs_five_groups/"
elif rmode == "attn_ana_hb":
    PATH2 = f"/Users/mac/Desktop/t3_mnt/transformer_tape_dnabert/data/training_data/attn_analysis_hb"
elif rmode == "attn_ana_pi":
    PATH2 = f"/Users/mac/Desktop/t3_mnt/transformer_tape_dnabert/data/training_data/attn_analysis_pi"

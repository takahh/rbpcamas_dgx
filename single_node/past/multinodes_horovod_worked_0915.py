...
def opt_trfmr(tfconfig):
    ...
    if tfconfig.training == 1:
        ...
        combined_dataset_train = combined_dataset_train.repeat(1).batch(dataset_batch).shard(num_shards=hvd.size(), index=hvd.rank())
        #
        ...
        combined_dataset_test = combined_dataset_test.repeat(1).shard(num_shards=hvd.size(), index=hvd.rank())
